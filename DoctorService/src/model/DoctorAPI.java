...
public class DoctorAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = doctorObj.insertDoctor(request.getParameter("docCode"),request.getParameter("docName"),
				request.getParameter("docPhone"), request.getParameter("docHospital"), request.getParameter("docSpecial"));
